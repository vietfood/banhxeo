...
from banhxeo.models import GENERATE_LOOP_UPPER_BOUND, GenerateConfig, ModelConfig
from banhxeo.models.prob import ProbLanguageModel
...
class NGramConfig(ModelConfig):
    ...
    def __str__(self):
        return f"NGramModel(n={self.n}, smoothing={self.smoothing}, k={self.k})"


class NGram(ProbLanguageModel):
    def __init__(
        self,
        vocab: Vocabulary,
        n: int = 2,
